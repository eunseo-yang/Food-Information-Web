   ...
   <div class="main-container">
      ...
      <section class="login-input-section-wrap">
        <form action="login_check.php" method="post">
          <div class="login-input-wrap">  
            <p><input placeholder="Username" type="text" name="id" id=></input></p>
         </div>
         <div class="login-input-wrap password-wrap">   
            <p><input placeholder="Password" type="password" name="pwd" id="pwd"></input></p>
         </div>
      ...
      <section class="Easy-sgin-in-wrap">
         ...
         <ul class="login-button-wrap">
                </li><button type='button' id='signup' onclick="location.href='register.php'">Sign Up</button>
            </ul>
      </section>
      </div>
   </div>
