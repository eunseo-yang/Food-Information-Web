   ...
   $gender = $_POST['gender'];
    ...
    ?>
        ...
        <form method="post" action="sign_update.php">
            <section class="login-input-section-wrap">
                <div class="login-input-wrap">	
                    <input placeholder="?먮옒 ID瑜??낅젰?섏꽭??" type="text" id="first_id" name="first_id"></input>
                </div>
                <div class="login-input-wrap">	
                    <input placeholder="?먮옒 PWD瑜??낅젰?섏꽭??" type="text" id="first_pwd" name="first_pwd"></input>
                </div>
                <div class="login-input-wrap">	
                    <input placeholder="蹂寃쏀븯怨??띠? ID瑜??낅젰?섏꽭??" type="text" id="modify_id" name="modify_id"></input>
                </div>
                <div class="login-input-wrap">	
                <input placeholder="蹂寃쏀븯怨??띠? PWD瑜??낅젰?섏꽭??" type="text" id="modify_pwd" name="modify_pwd"></input></div>
            </section>
        ...
        <form method="post" action="sign_delete.php">
            <section class="login-input-section-wrap">
                <div class="login-input-wrap">	
                    <input placeholder="??젣?섍퀬 ?띠? ID瑜??낅젰?섏꽭??" type="text" id="delete_id" name="delete_id"></input>
                </div>
                <div class="login-input-wrap">	
                <input placeholder="PWD瑜??낅젰?섏꽭??" type="text" id="delete_pwd" name="delete_pwd"></input></div>
            </section>
            <section class="Easy-sgin-in-wrap">
                <ul class="login-button-wrap">
