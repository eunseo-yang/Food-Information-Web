...
<?php
    ...
    $sql = "SELECT * FROM today_info WHERE user_id='$Id'";
    ...
    $sqlquery = "INSERT INTO today_info (`today_index`, `uesr_id`, `morning_menu`,'lunch_menu','lunch_menu','dinner_menu') VALUES ('$Date','$Id','$Breakfast','$Lunch','$Dinner')";
    echo "<script>alert('기록 완료되었습니다.');</script>";
    echo "<script>location.href='http://localhost/needed_cal_nut.html'</script>";
